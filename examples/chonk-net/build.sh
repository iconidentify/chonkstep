...
# supported way to ship). Same shape as examples/chonk-switch.
#
...
echo "chonk-net: could not find the chonkdock Python SDK." >&2
echo "Run the install from a chonkstep checkout, or copy" >&2
echo "bindings/python/chonkdock next to chonk-net.py." >&2
exit 1
