...
pub use backend::{Backend, LayoutDrag, OverviewDrag, OverviewChrome, OverviewCards, OverviewScene, OverviewWindow, OverviewWorkspace, OverviewThumbnail};
pub use client::{
...
pub use types::{
    ...
    CursorBehaviour, MultiFingerDrag, PointerConfig, ScrollClass, ScrollMethod, TapButtonMap, MAX_SCROLL_BUTTON,
