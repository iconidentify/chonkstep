// Adapted from Omarchy Ui/KeyboardPanel.qml (MIT).
// Use the configured layer surface size: older Chonkstep versions report
// rounded xdg-output sizes at fractional display scales.
import qs.Ui
import QtQuick
import Quickshell
...
PanelWindow {
  ...
  onBackingWindowVisibleChanged: {
    beginFocusPrime()
    if (open && backingWindowVisible && focusTarget) Qt.callLater(function() {
